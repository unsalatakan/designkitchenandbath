...
<?php
    ...
    $sql = "SELECT item_barcode, item_name, item_status, item_added_date, item_order_date, item_arriving_date, item_arrived_date, item_picked_up_pm_date, item_delivered_customer_date, item_po_name, item_is_condition_checked, item_current_location, item_photo_location,item_added_by FROM item";
    }else{
    $sql = "SELECT item_barcode, item_name, item_status, item_added_date, item_order_date, item_arriving_date, item_arrived_date, item_picked_up_pm_date, item_delivered_customer_date, item_po_name, item_is_condition_checked, item_current_location, item_photo_location,item_added_by FROM item";
    }
